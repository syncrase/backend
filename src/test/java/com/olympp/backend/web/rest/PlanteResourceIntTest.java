...
public class PlanteResourceIntTest {
    ...
    private static final String DEFAULT_PH_MIN = ",0";
    private static final String UPDATED_PH_MIN = "8,7";

    private static final String DEFAULT_PH_MAX = ",6";
    private static final String UPDATED_PH_MAX = "8";
